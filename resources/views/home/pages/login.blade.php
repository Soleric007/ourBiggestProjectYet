                        ...
                        <div class="user-login-card bg-body">
                            ...
                            <form method="POST" action="{{ route('login.store') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control rounded-0" type="email" name="email"
                            ...
                            <p class="my-4 text-center fw-500 text-white">New to Streamit? <a
                                    href="{{ route('register') }}" class="text-primary ms-1">Register</a></p>
                                    ...
                                    <a href="https:/facebook.com/" class="position-relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26"
                                            ...
                                            <path
                                                ...
                                                fill="white" />
                                            <defs>
                                                <linearGradient id="paint0_linear_770_72" x1="5.41271"
                                                    y1="5.41296" x2="21.9996" y2="21.9999"
