...
<div class="section-padding vh-100 image-flip-rtl" style="background: url('template/assets/images/pages/404-two.webp'); background-size: cover; background-repeat: no-repeat; position: relative;min-height:500px">
  <div class="container h-100">
    <div class="row h-100 align-items-center">
      <div class="col-lg-6"></div>
      <div class="col-lg-5">
        <img src="template/assets/images/pages/404-text.webp" class="mb-5" alt="404" loading="lazy">
