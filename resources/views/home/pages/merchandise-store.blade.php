                      ...
                      <div class="col-md-9">
                          <ul class="d-flex align-items-center justify-content-end gap-3 list-inline mb-0">
                              ...
                              <li class="dropdown" id="itemdropdown1">
                                  <a class="text-white d-flex align-items-center" href="#" id="navbarDropdown" role="button"
               ...
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/01.webp"
                       class="img-fluid"
                       alt="catImg-01"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/02.webp"
                       class="img-fluid"
                       alt="catImg-02"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/03.webp"
                       class="img-fluid"
                       alt="catImg-03"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/04.webp"
                       class="img-fluid"
                       alt="catImg-04"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/05.webp"
                       class="img-fluid"
                       alt="catImg-05"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/06.webp"
                       class="img-fluid"
                       alt="catImg-06"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/07.webp"
                       class="img-fluid"
                       alt="catImg-07"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/08.webp"
                       class="img-fluid"
                       alt="catImg-08"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/09.webp"
                       class="img-fluid"
                       alt="catImg-09"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/11.webp"
                       class="img-fluid"
                       alt="catImg-10"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="https://templates.iqonic.design/streamit-dist/frontend/html/assets/images/shop/categories/12.webp"
                       class="img-fluid"
                       alt="catImg-11"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/14.webp"
                       class="img-fluid"
                       alt="catImg-12"
                     />
                   </a>
            ...
            <li class="swiper-slide slide-item">
               <div class="category-inner position-relative">
                 <div class="category_image">
                   <a href="shop/shop.html">
                     <img
                       src="assets/images/shop/categories/15.webp"
                       class="img-fluid"
                       alt="catImg-13"
                     />
                   </a>
      ...
      <div class="row gx-lg-0">
         <div class="col-lg-4 col-md-6 d-flex flex-column">
            <div class="product-box left-1-productbox ">
               ...
               <div class="card-img-overlay product-card-img-overlay"
                  style="background-image: url(assets/images/shop/card/01.webp);">
               </div>
            ...
            <div class="product-box left-2-productbox">
               ...
               <div class="card-img-overlay product-card-img-overlay mt-lg-0 mt-md-4 mt-4"
                  style="background-image: url(assets/images/shop/card/02.webp);">
               </div>
               <div class="card-body w-100">
         ...
         <div class="col-lg-4 col-md-6 mt-md-0 mt-4">
            <div class="center-productbox product-box">
               <a href="shop/shop.html" class="card-link"></a>
               <div class="card-img-overlay product-card-img-overlay"
                  style="background-image: url(assets/images/shop/card/03.webp);">
               </div>
               <div class="card-body w-100">
         ...
         <div class="col-lg-4 col-md-12 d-flex flex-column mt-lg-0 mt-md-4 mt-4">
            <div class="product-box right-1-productbox">
               ...
               <div class="card-img-overlay product-card-img-overlay md-mt-5"
                  style="background-image: url(assets/images/shop/card/04.webp);">
               </div>
               <div class="card-body w-100">
                  <h5 class="card-title">Harry David </h5>
                  <h4 class="parent-heading">Warner Bros Films</h4>
            ...
            <div class="product-box right-2-productbox">
               <a href="shop/shop.html" class="card-link"></a>
               <div class="card-img-overlay product-card-img-overlay mt-lg-0 mt-md-4 mt-4"
                  style="background-image: url(assets/images/shop/card/05.webp);">
               </div>
               <div class="card-body w-100">
   ...
   <div class="container-fluid">
      <div class="overflow-hidden">
         <div class="d-flex align-items-center justify-content-between px-3 my-4">
            ...
            <a href="shop/view-all-product.html" class="text-primary iq-view-all text-decoration-none flex-none">Want
               More?</a>
         </div>
                       ...
                       <div class="image-wrap">
                         <a href="shop/product-detail.html">
                           <div class="product-image">
                             <img src="assets/images/shop/product/01.webp" class="img-fluid w-100" alt="productImg-01"
                               loading="lazy" />
                           </div>
                         </a>
                  ...
                  <li class="swiper-slide">
                     <div class="product-block">
                       <div class="image-wrap">
                         <a href="shop/product-detail.html">
                           <div class="product-image">
                             <img src="assets/images/shop/product/02.webp" class="img-fluid w-100" alt="productImg-02"
                               loading="lazy" />
                           </div>
                         </a>
                         <div class="buttons-holder">
                  ...
                  <li class="swiper-slide">
                     <div class="product-block">
                       ...
                       <div class="image-wrap">
                         <a href="shop/product-detail.html">
                           <div class="product-image">
                             <img src="assets/images/shop/product/03.webp" class="img-fluid w-100" alt="productImg-03"
                               loading="lazy" />
                           </div>
                         </a>
                         <div class="buttons-holder">
                  ...
                  <li class="swiper-slide">
                     <div class="product-block">
                       ...
                       <div class="image-wrap">
                         <a href="shop/product-detail.html">
                           <div class="product-image">
                             <img src="assets/images/shop/product/04.webp" class="img-fluid w-100" alt="productImg-04"
                               loading="lazy" />
                           </div>
                         </a>
                         <div class="buttons-holder">
                  ...
                  <li class="swiper-slide">
                     <div class="product-block">
                       <div class="image-wrap">
                         <a href="shop/product-detail.html">
                           <div class="product-image">
                             <img src="assets/images/shop/product/05.webp" class="img-fluid w-100" alt="productImg-05"
                               loading="lazy" />
                           </div>
                         </a>
                         <div class="buttons-holder">
                  ...
                  <li class="swiper-slide">
                     <div class="product-block">
                       <div class="image-wrap">
                         <a href="shop/product-detail.html">
                           <div class="product-image">
                             <img src="assets/images/shop/product/06.webp" class="img-fluid w-100" alt="productImg-06"
                               loading="lazy" />
                           </div>
                         </a>
                         <div class="buttons-holder">
      ...
      <div class="row">
         <div class="col-lg-6 col-md-6">
            <div class="categorie-about-left">
               <div class="categorie-about-image">
                  <img src="assets/images/shop/card/capton-america.webp" class="img-fluid" alt="shop">
               </div>
               <div class=" text-left mb-4 pt-3">
                  <h4 class="mb-2 line-count-1">Captain America</h4>
                  <p class="mb-4 mt-2 line-count-3">Lorem Ipsum is simply dummy text of the printing and typesetting
                     industry.</p>
                  <div class="iq-button">
         ...
         <div class="col-lg-6 col-md-6">
            <div class="categorie-about-right">
               <div class="categorie-about-image">
                  <img src="assets/images/shop/card/deadpool.webp" class="img-fluid" alt="shop">
               </div>
               <div class=" text-left mb-4 pt-3">
...
<div class="best-product-block section-padding-top">
   <div class="container-fluid">
      <div class="overflow-hidden">
         <div class="d-flex align-items-center justify-content-between px-3 my-4">
            <h5 class="main-title text-capitalize mb-0">Best Sellers</h5>
            <a href="shop/view-all-product.html" class="text-primary iq-view-all text-decoration-none flex-none">Want
               More?</a>
         </div>
         <div class="card-style-slider">
...
<div class="product_container">
   <div class="row gx-0">
      ...
      <div class="shop-contact col-lg-6 col-md-12">
         <img class="img-fluid h-100 w-100" src="assets/images/shop/card/location.webp" alt="">
      </div>
   </div>
</div>
