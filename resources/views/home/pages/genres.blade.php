...
<section class="section-padding">
    <div class="container-fluid">
        <div class="mb-4 d-flex align-items-center justify-content-between">
            <h4 class="mb-0 main-title text-capitalize">Movie Genres</h4>
        </div>
...
<section class="section-padding-bottom">
    <div class="container-fluid">
        <div class="mb-4 d-flex align-items-center justify-content-between">
            <h4 class="mb-0 main-title text-capitalize">Tv-Show Genres</h4>
        </div>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
            <div class="mb-4 col">
                <div class="iq-card-geners card-hover-style-two">
                ...
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="template/assets/images/genre/02.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">Adventure</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="template/assets/images/genre/03.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">Animation</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="template/assets/images/genre/04.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">Comedy</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="template/assets/images/genre/05.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">Drama</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="template/assets/images/genre/06.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">Family</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="template/assets/images/genre/07.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">Fantacy</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="section-padding-bottom">
    <div class="container-fluid">
        <div class="mb-4 d-flex align-items-center justify-content-between">
            <h4 class="mb-0 main-title text-capitalize">Video Genres</h4>
        </div>
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4">
            <div class="mb-4 col">
                <div class="iq-card-geners card-hover-style-two">
