...
<body class="">
  ...
  <main class="main-content">
    ...
    <section class="section-padding">
        <div class="container-fluid">
            <div class="mb-4 d-flex align-items-center justify-content-between">
                <h4 class="mb-0 main-title text-capitalize">Movie Tag</h4>
            </div>
    ...
    <section class="section-padding-bottom">
        <div class="container-fluid">
            <div class="mb-4 d-flex align-items-center justify-content-between">
                <h4 class="mb-0 main-title text-capitalize">Tv-Show Tag</h4>
            </div>
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 row-cols-xl-6">
                <div class="col">
                    <a href="view-all-{{ route('movie') }}" class="iq-tag-box">
    ...
    <section class="section-padding-bottom">
        <div class="container-fluid">
            <div class="mb-4 d-flex align-items-center justify-content-between">
                <h4 class="mb-0 main-title text-capitalize">Video Tag</h4>
            </div>
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 row-cols-xl-6">
                <div class="col">
                    <a href="view-all-{{ route('movie') }}" class="iq-tag-box">
