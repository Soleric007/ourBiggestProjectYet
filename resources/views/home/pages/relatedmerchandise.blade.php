          ...
          <div class="position-relative swiper swiper-card" data-slide="5" data-laptop="5" data-tab="3" data-mobile="2"
            ...
            <ul class="list-inline swiper-wrapper">
              <li class="swiper-slide">
                <div class="m-0 cast-images row align-items-center position-relative">
                  <div class="p-0 col-4 img-box">
                    <img src="template/assets/images/genre/g4.webp" class="img-fluid" alt="image" loading="lazy">
                  </div>
              ...
              <li class="swiper-slide">
                <div class="m-0 cast-images row align-items-center position-relative">
                  <div class="p-0 col-4 img-box">
                    <img src="template/assets/images/genre/g1.webp" class="person__poster--image img-fluid" alt="image"
                      loading="lazy">
                  </div>
                  <div class="col-8 block-description starring-desc ">
                    <h6 class="iq-title">
  ...
  <div class="container-fluid">
    <div class="overflow-hidden">
      <div class="px-3 pt-2 my-4 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 main-title text-capitalize">Recommended</h5>
      </div>
  ...
  <div class="container-fluid">
    <section class="overflow-hidden">
      <div class="px-3 my-4 d-flex align-items-center justify-content-between">
        <h5 class="mb-0 main-title text-capitalize">Related Products</h5>
