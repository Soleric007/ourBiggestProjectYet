                      ...
                      <ul class="navbar-nav iq-nav-menu list-unstyled" id="header-menu">
                        ...
                        <li class="nav-item">
                          ...
                          <ul class="sub-nav collapse list-unstyled" id="features">
                            ...
                            <li class="nav-item">
                              <a class="nav-link active" href="geners.html"> Genres </a>
                            </li>
                            <li class="nav-item">
        ...
        <div class="row">
            <div class="my-4 col-sm-12">
                <div class="d-flex align-items-center justify-content-between">
                    <h5 class="mb-0 main-title text-capitalize">genres</h5>
                </div>
            </div>
        </div>
        <div class="row row-cols-xl-5 row-cols-md-2 row-cols-1 geners-card geners-style-grid">
                ...
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="assets/images/genre/01.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">action</a></h6>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col slide-items">
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="assets/images/genre/02.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">action</a></h6>
                            </div>
                        </div>
            ...
            <div class="col slide-items">
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="assets/images/genre/03.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">action</a></h6>
                            </div>
                        </div>
            ...
            <div class="col slide-items">
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="assets/images/genre/04.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">action</a></h6>
                            </div>
                        </div>
            ...
            <div class="col slide-items">
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="assets/images/genre/05.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">action</a></h6>
                            </div>
                        </div>
            ...
            <div class="col slide-items">
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="assets/images/genre/06.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">action</a></h6>
                            </div>
                        </div>
            ...
            <div class="col slide-items">
                <div class="iq-card-geners card-hover-style-two">
                    <div class="block-images position-relative w-100">
                        <div class="rounded img-box position-relative">
                            <img src="assets/images/genre/07.webp" alt="geners-img" class="object-cover rounded img-fluid w-100">
                            <div class="blog-description">
                                <h6 class="mb-0 iq-title"><a href="" class="p-2 text-decoration-none text-capitalize line-count-2">action</a></h6>
                            </div>
                        </div>
