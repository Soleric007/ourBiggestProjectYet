                          ...
                          <ul class="d-flex align-items-center justify-content-end gap-3 list-inline mb-0">
                              ...
                              <li class="dropdown" id="itemdropdown1">
                                  ...
                                  <ul class="dropdown-menu dropdown-menu-end dropdown-user border-0 p-0 m-0"
                                      ...
                                      <li>
                                          <a href="https://templates.iqonic.design/streamit-dist/frontend/html/shop/view-all-{{ route('movie') }}" class="iq-sub-card d-flex align-items-center gap-3">
                                      ...
                                      <li>
                                          <a href="https://templates.iqonic.design/streamit-dist/frontend/html/shop/{{ route('pricingplan') }}" class="iq-sub-card d-flex align-items-center gap-3">
                                              <i class="fa-regular fa-star"></i>
                                              <h6 class="mb-0 font-size-14 fw-normal">Subscription</h6>
                                          </a>
                                      </li>
                                      <li>
                                          <a href="{{ route('login') }}" class="iq-sub-card iq-logout-2 mt-1 d-flex justify-content-center gap-2">
                              ...
                              <div class="collapse navbar-collapse p-3" id="navbarSupportedContent">
                                  <div class="iq-meta-menu-container d-xl-block d-none">
                                      <ul class="d-flex align-items-center m-0 list-inline iq-meta-menu">
                                          ...
                                          <li>
                                              <a href="{{ route('comingsoon') }}">Help?</a>
                                          </li>
                                      </ul>
                                  </div>
                                  <div class="d-xl-none">
                                      <ul class="d-flex align-items-center justify-content-end gap-3 list-inline mb-0">
                                          ...
                                          <li class="dropdown" id="itemdropdown2">
                                              ...
                                              <div class="dropdown-menu dropdown-menu-end dropdown-user border-0 p-0 m-0"
                                                  ...
                                                  <a href="https://templates.iqonic.design/streamit-dist/frontend/html/shop/view-all-{{ route('movie') }}"
                                                  ...
                                                  <a href="https://templates.iqonic.design/streamit-dist/frontend/html/shop/{{ route('pricingplan') }}"
                                                      class="iq-sub-card d-flex align-items-center gap-3">
                                                      <i class="fa-regular fa-star"></i>
                                                      <h6 class="mb-0 font-size-14 fw-normal">Subscription</h6>
                                                  </a>
              ...
              <div class="sidebar-cart-content d-flex flex-column justify-content-between">
                  ...
                  <div class="cart-progress-container mt-5 pt-5 border-top">
                      ...
                      <div class="d-grid gap-3 mt-4">
                          <a href="{{ route('checkout') }}" class="btn bg-primary text-uppercase fw-medium w-100 text-white">
                        ...
                        <ul class="list-unstyled p-0 m-0 shop-list-checkbox">
                            ...
                            <li>
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <a class="checkbox" data-bs-toggle="collapse" href="#categoriesone" role="button" aria-expanded="false"
                    ...
                    <div class="shop-box border-bottom-0">
                        ...
                        <ul class="list-unstyled m-0 p-0 shop-product">
                            <li class="d-flex align-items-center mb-4">
                                ...
                                <div>
                                    <a href="{{ route('productdetail') }}">Bag Pack</a>
                                    <p>$10.00</p>
                                </div>
                            </li>
                            <li class="d-flex align-items-center mb-4">
                            ...
                            <ul class="nav_shop nav d-flex nav-pills mb-0 iq-product-filter d-flex bg-transparent align-items-center list-inline"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link btn-sm btn-icon rounded-pill p-0" id="list-view-tab"
                                        ...
                                        aria-controls="pills-list-view" aria-selected="true">
                                        <span class="btn-inner">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link btn-sm btn-icon rounded-pill p-0" id="grid-view-tab"
                                        ...
                                        aria-controls="pills-grid-view" aria-selected="false">
                                        <span class="btn-inner">
                                    ...
                                    <div class="col-md-8">
                                        <div class="product-caption">
                                          <h5 class="product__title">
                                            <a href="https://templates.iqonic.design/streamit-dist/frontend/html/shop/{{ route('productdetail') }}" class="title-link">
                                              Bag Pack</a>
                                          </h5>
                                          ...
                                          <p class="blog-desc line-count-2">There are many variations of
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="product-caption">
                                          ...
                                          <p class="blog-desc line-count-2">There are many variations of passages
