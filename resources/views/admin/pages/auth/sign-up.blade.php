               ...
               <div class="sign-in-page-data">
                  <div class="m-auto sign-in-from w-100">
                     <form action="https://templates.iqonic.design/">
                        ...
                        <div class="my-2 form-check"><input type="radio" id="customRadio1" name="customRadio"
