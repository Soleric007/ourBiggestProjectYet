...
<head>
    ...
    <!-- Flatpickr css -->
    <link rel="stylesheet" href="../../../../../public/admin/assets/vendor/flatpickr/dist/flatpickr.min.css">



    <!-- Sweetlaert2 css -->
    <link rel="stylesheet" href="../../../../../public/admin/assets/vendor/sweetalert2/dist/sweetalert2.min.css">
               ...
               <div class="container-fluid navbar-inner">
                  ...
                  <div class="d-flex align-items-center justify-content-between product-offcanvas">
                     <div class="breadcrumb-title border-end pe-3 d-none d-xl-block">
                        <small class="mb-0 text-capitalize">movie list</small>
                     </div>
                        ...
                        <div class="offcanvas-body">
                           <ul class="iq-nav-menu list-unstyled">
                              ...
                              <li class="nav-item"><a class="nav-link active"
                                    href="movie-list.html">Movie List</a></li>
                              <li class="nav-item">
...
<div class="row">
    <div class="col-sm-12">
        <div class="pb-3 card">
            <div class="py-3 card-header border-bottom d-flex justify-content-between align-items-center">
                ...
                <button class="mt-3 btn btn-primary" type="button" data-bs-toggle="offcanvas"
                    data-bs-target="#season-offcanvas" aria-controls="season-offcanvas"><i
                        class="fa-solid fa-plus me-2"></i>Add Movie</button>
            </div>
            <div class="card-body">
                <div class="pt-3 table-view table-responsive table-space">
                    <table id="seasonTable" class="table data-tables custom-table movie_table" data-toggle="data-table">
                        <thead>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/03.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-user-action">
                                        <button type="button" class="rounded btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Edit">
                                        ...
                                        <a class="rounded btn btn-sm btn-icon btn-danger delete-btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Delete" href="#">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/04.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/05.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/06.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/07.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/08.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/09.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/10.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/02.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <img src="../../../../../public/admin/assets/images/movie-thumb/01.jpg" alt="image" class="rounded-2 avatar avatar-55 img-fluid" />
                                        <div class="d-flex flex-column ms-3 justify-content-center">
    ...
    <div class="offcanvas offcanvas-end offcanvas-width-80" tabindex="-1" id="season-offcanvas"
            ...
            <form>
                <div class="section-form">
                    <fieldset>
                            ...
                            <div class="col-sm-6">
                                <div class="px-3 form-group">
                                    <label class="form-label flex-grow-1" for="movie-access"><strong>Movie
                                            Access:</strong></label>
                                    <select id="movie-access" type="select" class="form-control select2-basic-multiple"
                        ...
                        <div class="px-3 my-4 d-flex justify-content-between align-items-center">
                            <h5 class="mb-0">
                                        ...
                                        <div class="modal-body">
                                            <form action="" class="section-form">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="px-3 form-group d-flex flex-column">
                                                            <label class="form-label flex-grow-1"
                                                                for="cast-occupation"><strong>Occupation:</strong></label>
                                                            <select id="cast-occupation" type="select" class="form-control select2-basic-multiple"
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="px-3 form-group d-flex justify-content-between">
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <a aria-current="page" href="#" class="active text-success"
                                                            title="Edit">
                                                            <i class="mx-4 fa-solid fa-pen"></i>
                                                        </a>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="px-3 form-group ">
                                    ...
                                    <!-- toggle switch -->
                                    <!-- common inputs -->
                                    <input id="SEO Title" type="text" class="form-control " placeholder="Enter seo title" value="" min=""
                                       multiple="" />
                                </div>                            </div>
                            <div class="col-sm-12">
                                <div class="px-3 form-group ">
                    ...
                    <fieldset>
                        ...
                        <div class="px-3 my-4 d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#video-modal">
                        ...
                        <div class="px-3 my-4 d-flex justify-content-between align-items-center">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#subtitle-modal">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="px-3 form-group d-flex flex-column">
                                                            ...
                                                            <select id="subtitle-language" type="select" class="form-control select2-basic-multiple"
        ...
        <div class="offcanvas-footer border-top">
            <div class="gap-3 p-3 d-grid d-flex">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="px-3 form-group ">
                                    ...
                                    <!-- textarea input -->
                                    <textarea id="Description" class="form-control" placeholder="Description">Lorem Ipsum is simply dummy text of the printing and
                                                                typesetting industry</textarea>
                                </div>                            </div>
                            <div class="col-sm-6">
                                <div class="px-3 form-group">
                                    <label class="form-label flex-grow-1" for="movie-access1"><strong>Movie
                                            Access:</strong></label>
                                    <select id="movie-access1" type="select" class="form-control select2-basic-multiple"
                                        placeholder="select movie access">
                                        <option>Free</option>
                            ...
                            <div class="col-sm-6">
                                <div class="px-3 form-group">
                                    <label class="form-label flex-grow-1"
                                        for="language1"><strong>Language:</strong></label>
                            ...
                            <div class="col-sm-12">
                                <div class="px-3 form-group">
                                    <label class="form-label flex-grow-1" for="Genres1"><strong>Genres:</strong></label>
                                    <select id="Genres1" type="select" class="form-control select2-basic-multiple"
                                        placeholder="select genres">
                                        <option>Action</option>
                                        <option>Adventure</option>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="px-3 form-group ">
                                    ...
                                    <!-- toggle switch -->
                                    <!-- common inputs -->
                                    <input id="SEO Title" type="text" class="form-control " placeholder="Enter seo title" value="v1" min=""
                                       multiple="" />
                                </div>                            </div>
                            <div class="col-sm-12">
                                <div class="px-3 form-group ">
                                    ...
                                    <!-- textarea input -->
                                    <textarea id="SEO Description" class="form-control" placeholder="SEO Description">Lorem Ipsum is simply dummy text of the printing
                                                                and typesetting industry</textarea>
                                </div>                            </div>
                            <div class="col-sm-12">
                                <div class="px-3 form-group">
                                    <label class="form-label flex-grow-1"
                                        for="genres2"><strong>Keywords:</strong></label>
                                    <select id="genres2" type="select" class="form-control select2-basic-multiple"
                                        placeholder="select genres">
                                        <option>A</option>
                                        <option>B</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="px-3 form-group ">
                                    ...
                                    <!-- toggle switch -->
                                    <!-- common inputs -->
                                    <input id="Trailer Url" type="text" class="form-control " placeholder="Trailer Link" value="www.demo.com" min=""
                                       multiple="" />
                                </div>                            </div>
                        </div>
                        <div class="px-3 my-4 d-flex justify-content-between align-items-center">
                                            ...
                                            <form action="" class="section-form">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="px-3 form-group d-flex flex-column">
                                                            <label class="form-label flex-grow-1"
                                                                for="quality-edit"><strong>Quality:</strong></label>
                                                            <select id="quality-edit" type="select" class="form-control select2-basic-multiple"
                                                                placeholder="Select Quality">
                                                                <option>480p</option>
    ...
    <!-- Flatpickr Script -->
    <script src="../../../../../public/admin/assets/vendor/flatpickr/dist/flatpickr.min.js"></script>
    <script src="../../../../../public/admin/assets/js/plugins/flatpickr.js" defer></script>
    ...
    <!-- Sweet-alert Script -->
    <script src="../../../../../public/admin/assets/vendor/sweetalert2/dist/sweetalert2.min.js" async></script>
    <script src="../../../../../public/admin/assets/js/plugins/sweet-alert.js" defer></script>
