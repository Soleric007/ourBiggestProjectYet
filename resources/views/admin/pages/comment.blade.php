               ...
               <div class="container-fluid navbar-inner">
                  ...
                  <div class="d-flex align-items-center justify-content-between product-offcanvas">
                     <div class="breadcrumb-title border-end pe-3 d-none d-xl-block">
                        <small class="mb-0 text-capitalize">Comment List</small>
                     </div>
        ...
        <div class="card">
            <div class="py-3 card-header border-bottom d-flex justify-content-between align-items-center">
                <div class="card-title">
                    <h4 class="m-0">Comment List</h4>
                </div>
            </div>
            <div class="card-body">
                <div class="table-view table-responsive table-space">
                    <table id="commentTable" class="table data-tables custom-table movie_table" data-toggle="data-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Title</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-user-action">
                                        <a class="rounded btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit" href="#">
