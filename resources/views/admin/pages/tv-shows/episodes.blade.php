               ...
               <div class="container-fluid navbar-inner">
                  ...
                  <div class="d-flex align-items-center justify-content-between product-offcanvas">
                     <div class="breadcrumb-title border-end pe-3 d-none d-xl-block">
                        <small class="mb-0 text-capitalize">episodes</small>
                     </div>
                     <div class="shadow-none offcanvas offcanvas-end iq-product-menu-responsive" tabindex="-1" id="offcanvasBottom">
                        <div class="offcanvas-body">
                           <ul class="iq-nav-menu list-unstyled">
                              ...
                              <li class="nav-item">
                                 <a class="nav-link menu-arrow active"
                                 ...
                                 <ul aria-expanded="false" class="iq-header-sub-menu left list-unstyled collapse" id="tv-shows">
                                    <li class="nav-item"><a class="nav-link "
                                          href="show-list.html">Show List</a></li>
                                    <li class="nav-item"><a class="nav-link "
                                          href="season.html">Season</a></li>
                                    <li class="nav-item"><a class="nav-link active"
                                          href="episodes.html">Episodes</a></li>
                                 </ul>
                              </li>
                           </ul>
                        </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="pb-3 card">
            <div class="py-3 card-header border-bottom d-flex justify-content-between align-items-center">
                ...
                <button class="px-2 mt-3 btn btn-primary px-lg-3" type="button" data-bs-toggle="offcanvas"
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="px-3 form-group">
                                        <label class="form-label flex-grow-1"
                                            for="season"><strong>Seasons:</strong></label>
                                        <select id="season" type="select" class="form-control select2-basic-multiple"
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="px-3 form-group">
                                        <label class="form-label flex-grow-1"
                                            for="movie-access-1"><strong>Show:</strong></label>
                                        <select id="movie-access-1" type="select"
                                            class="form-control select2-basic-multiple"
                                            placeholder="select movie access">
                                            <option>Zombie Island</option>
                                            <option>Folke The Fat</option>
                                ...
                                <div class="col-sm-12">
                                    <div class="px-3 form-group ">
                                        ...
                                        <!-- textarea input -->
                                        <textarea id="Description" class="form-control" placeholder="Description">Lorem Ipsum is simply dummy text of the printing
    ...
    <script src="../../../../../public/admin/assets/js/plugins/flatpickr.js" defer></script>
      ...
      <!-- Select2 Script -->
      <script src="../../../../../public/admin/assets/js/plugins/select2.js" defer></script>
