               ...
               <div class="container-fluid navbar-inner">
                  ...
                  <div class="d-flex align-items-center justify-content-between product-offcanvas">
                     <div class="breadcrumb-title border-end pe-3 d-none d-xl-block">
                        <small class="mb-0 text-capitalize">season</small>
                     </div>
        ...
        <div class="pb-3 card">
            <div class="py-3 card-header border-bottom d-flex justify-content-between align-items-center">
                ...
                <button class="mt-3 btn btn-primary" type="button" data-bs-toggle="offcanvas"
                    ...
                    <i class="fa-solid fa-plus me-2"></i>Add Season
                </button>
            </div>
            <div class="card-body">
                    ...
                    <fieldset>
                        ...
                        <div class="form-group">
                            <div class="px-3 form-group ">
                                ...
                                <label class="form-label flex-grow-1" for="shows"><strong>Show:</strong></label>
                ...
                <form action="" class="section-form">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="px-3 form-group">
                                <label class="form-label flex-grow-1" for="shows1"><strong>Show:</strong></label>
                                <select id="show1" type="select" class="form-control select2-basic-multiple">
                                    <option>abc</option>
