...
<head>
    ...
    <link rel="stylesheet" href="../../../../public/admin/assets/vendor/sheperd/dist/css/sheperd.css">
    ...
    <link rel="stylesheet" href="../../../../public/admin/assets/vendor/swiperSlider/swiper-bundle.min.css">
...
<div class="row">
    <div class="col-lg-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="pt-2 overflow-hidden swiper pt-md-4 pt-lg-4" data-swiper="top-slider">
                    <ul class="p-0 m-0 swiper-wrapper list-inline">
                        <li class="iq-rated-box swiper-slide">
                            <div class="mb-0 iq-card">
                                <div class="p-0 iq-card-body">
                                    <div class="iq-thumb">
                                        <a href="javascript:void(0)">
                                            <img src="../../../../public/admin/assets/images/dashboard/01.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-01">
                                        </a>
                                    </div>
                                    <div class="mt-3 iq-feature-list">
                                        <h6 class="mb-0 font-weight-600">The
                                                        Last Breath</h6>
                                        <p class="mt-2 mb-0">T.V Show</p>
                                        <div class="my-2 d-flex align-items-center iq-ltr-direction">
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="mb-0 iq-card">
                                <div class="p-0 iq-card-body">
                                    <div class="iq-thumb">
                                        <a href="javascript:void(0)">
                                            <img src="../../../../public/admin/assets/images/dashboard/02.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-02">
                                        </a>
                                    </div>
                                    <div class="mt-3 iq-feature-list">
                                        <h6 class="mb-0 font-weight-600">Last
                                                        Night</h6>
                                        <p class="mt-2 mb-0">Movie</p>
                                        <div class="my-2 d-flex align-items-center iq-ltr-direction">
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="mb-0 iq-card">
                                <div class="p-0 iq-card-body">
                                    <div class="iq-thumb">
                                        <a href="javascript:void(0)">
                                            <img src="../../../../public/admin/assets/images/dashboard/03.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-03">
                                        </a>
                                    </div>
                                    <div class="mt-3 iq-feature-list">
                                        <h6 class="mb-0 font-weight-600">Jeon
                                                        Woochie</h6>
                                        <p class="mt-2 mb-0">Movie</p>
                                        <div class="my-2 d-flex align-items-center iq-ltr-direction">
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="mb-0 iq-card">
                                <div class="p-0 iq-card-body">
                                    <div class="iq-thumb">
                                        <a href="javascript:void(0)">
                                            <img src="../../../../public/admin/assets/images/dashboard/04.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-04">
                                        </a>
                                    </div>
                                    <div class="mt-3 iq-feature-list">
                                        <h6 class="mb-0 font-weight-600">Dino
                                                        Land</h6>
                                        <p class="mt-2 mb-0">T.V Show</p>
                                        <div class="my-2 d-flex align-items-center iq-ltr-direction">
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="mb-0 iq-card">
                                <div class="p-0 iq-card-body">
                                    <div class="iq-thumb">
                                        <a href="javascript:void(0)">
                                            <img src="../../../../public/admin/assets/images/dashboard/05.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-05">
                                        </a>
                                    </div>
                                    <div class="mt-3 iq-feature-list">
                                        <h6 class="mb-0 font-weight-600">Last
                        ...
                        <li class="iq-rated-box swiper-slide">
                            <div class="mb-0 iq-card">
                                <div class="p-0 iq-card-body">
                                    <div class="iq-thumb">
                                        <a href="javascript:void(0)">
                                            <img src="../../../../public/admin/assets/images/dashboard/06.jpg" class="img-fluid w-100 img-border-radius" alt="topImg-06">
                                        </a>
                                    </div>
                                    <div class="mt-3 iq-feature-list">
                                        <h6 class="mb-0 font-weight-600">Open
                                                        Dead Shot</h6>
                                        <p class="mt-2 mb-0">T.V Show</p>
                                        <div class="my-2 d-flex align-items-center iq-ltr-direction">
                                            <p class="mb-0 me-2"><i class="fa-regular fa-eye me-1"></i>134</p>
    ...
    <div class="col-lg-4">
        <div class="card card-block card-stretch card-height">
            <div class="card-header">
                <div class="iq-header-title">
                    <h4 class="text-center card-title">User's Of Product</h4>
                </div>
            </div>
                ...
                <div class="mt-1 row">
                    <div class="col-sm-6 col-md-3 col-lg-6 iq-user-list">
                        <div class="border-0 card">
                            <div class="p-3 card-body bg-body">
                                <div class="d-flex align-items-center">
...
<div class="row">
    ...
    <div class="col-lg-8">
        <div class="card card-block card-stretch card-height">
            ...
            <div class="card-body row align-items-center">
                <div class="col-lg-7">
                    <div class="pb-0 mb-0 row list-unstyled">
                        <div class="mb-3 col-sm-6 col-md-4 col-lg-6">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="rounded iq-icon-box-view me-3 text-primary">
                                    <i class="fa-solid fa-film font-size-32"></i>
                                </div>
                                <div class="">
                                    <h6 class="mb-0 font-size-14 line-height">Actions</h6>
                                    <small class="mb-0 text-primary">+34%</small>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 col-sm-6 col-md-4 col-lg-6">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="rounded iq-icon-box-view me-3 text-secondary">
                                    <i class="fa-solid fa-masks-theater font-size-32"></i>
                                </div>
                                <div class="">
                                    <p class="mb-0 font-size-14 line-height">Comedy</p>
                                    <small class="mb-0 text-secondary">+44%</small>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 col-sm-6 col-md-4 col-lg-6">
                        ...
                        <div class="mb-3 col-sm-6 col-md-4 col-lg-6">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="rounded iq-icon-box-view me-3 text-warning">
                                    <i class="fa-solid fa-masks-theater font-size-32"></i>
                                </div>
                                <div class="">
                                    <p class="mb-0 font-size-14 line-height">Drama</p>
                                    <small class="mb-0 text-warning">+65%</small>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 col-sm-6 col-md-4 col-lg-6 mb-lg-0">
                            ...
                            <div class="mb-3 d-flex align-items-center mb-lg-0">
                                <div class="rounded iq-icon-box-view me-3 text-success">
                                    <i class="fa-solid fa-child font-size-32"></i>
                                </div>
                                <div class="">
                                    <p class="mb-0 font-size-14 line-height">Kids</p>
                                    <small class="mb-0 text-success">+74%</small>
                                </div>
                            </div>
                        </div>
                        <div class="mb-3 col-sm-6 col-md-4 col-lg-6 mb-lg-0">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive table-view table-space">
                    <table class="table data-tables custom-table movie_table" style="width:100%"
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="iq-movie">
                                            <a href="javascript:void(0);"><img src="../../../../public/admin/assets/images/movie-thumb/07.jpg"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="iq-movie">
                                            <a href="javascript:void(0);"><img src="../../../../public/admin/assets/images/movie-thumb/01.jpg"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="iq-movie">
                                            <a href="javascript:void(0);"><img src="../../../../public/admin/assets/images/movie-thumb/05.jpg"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="iq-movie">
                                            <a href="javascript:void(0);"><img src="../../../../public/admin/assets/images/movie-thumb/10.jpg"
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="iq-movie">
                                            <a href="javascript:void(0);"><img src="../../../../public/admin/assets/images/movie-thumb/04.jpg"
    ...
    <!-- Plugin Scripts -->
    <!-- Tour plugin Start -->
    <script src="../../../../public/admin/assets/vendor/sheperd/dist/js/sheperd.min.js"></script>
    <script src="../../../../public/admin/assets/js/plugins/tour.js" defer></script>
    ...
    <!-- SwiperSlider Script -->
    <script src="../../../../public/admin/assets/vendor/swiperSlider/swiper-bundle.min.js"></script>
    <script src="../../../../public/admin/assets/js/plugins/swiper-slider.js" defer></script>
    <!-- Lodash Utility -->
