...
<div class="row">
   <div class="col-md-12">
      <div class="mb-3 text-center row row-cols-1 row-cols-md-2 row-cols-lg-4">
         <div class="col">
            <div class="mb-4 card">
               <div class="card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title">Free</h5>
                  <h2 class="mb-3"><b>$0</b><br>
                     /Month</h2>
                  <button type="button" class="mb-5 btn btn-primary">Get started</button>
               </div>
               <div class="card-body">
         ...
         <div class="col">
            <div class="mb-4 card">
               <div class="card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title">Pro</h5>
         ...
         <div class="col">
            <div class="mb-4 card">
               <div class="card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title">Enterprise</h5>
         ...
         <div class="col">
            <div class="mb-4 card">
               <div class="card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title">Premium</h5>
         ...
         <div class="col-sm-12">
            <div class="card">
               ...
               <div class="p-0 card-body">
                  <div class="pt-2 table-responsive pricing">
                     <table id="my-table" class="table mb-0">
                        <thead>
                           <tr>
                              <th class="prc-wrap" style="width: 20%;"></th>
                              <th class="text-center prc-wrap" style="width: 20%;">
      ...
      <div class="mb-3 text-center row row-cols-1 row-cols-md-2 row-cols-lg-3">
         <div class="col">
            <div class="mb-4 card">
               <div class="p-4 card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title"><b>Basic Plan</b></h5>
               ...
               <div class="card-body">
                  <ul class="p-0 mb-0 list-unstyled">
                     <li class="mb-5">
                        <p class="mb-0 d-flex justify-content-center align-items-center"><svg width="14" height="14"
                              class="me-3" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
                                 d="M7.65103 1.07509L9.13535 4.05794C9.24471 4.27405 9.45342 4.42413 9.69414 4.45748L13.0282 4.94306C13.2229 4.97041 13.3996 5.07312 13.519 5.22987C13.637 5.38462 13.6877 5.58072 13.659 5.77348C13.6356 5.93356 13.5603 6.08164 13.4449 6.19503L11.0291 8.53689C10.8524 8.7003 10.7724 8.94242 10.815 9.17921L11.4098 12.4716C11.4732 12.8691 11.2098 13.2439 10.815 13.3193C10.6523 13.3453 10.4856 13.318 10.3389 13.2433L7.36497 11.6938C7.14426 11.5824 6.88353 11.5824 6.66282 11.6938L3.68885 13.2433C3.32343 13.4374 2.87067 13.3053 2.66729 12.9451C2.59194 12.8017 2.56527 12.6383 2.58994 12.4789L3.18474 9.18588C3.22741 8.94976 3.14673 8.7063 2.97069 8.54289L0.554841 6.20236C0.267446 5.92489 0.258777 5.46799 0.535503 5.18051C0.541504 5.17451 0.548172 5.16784 0.554841 5.16117C0.669532 5.04444 0.820231 4.97041 0.982932 4.95106L4.31698 4.46481C4.55703 4.4308 4.76574 4.28206 4.87577 4.06461L6.30674 1.07509C6.4341 0.818961 6.69816 0.659547 6.98489 0.666217H7.07424C7.32296 0.696232 7.53967 0.850311 7.65103 1.07509Z"
                                 fill="currentColor" />
                              <path
                     ...
                     <li class="mb-5">
                        <p class="mb-0 d-flex justify-content-center align-items-cente"> <svg width="14" height="14"
                              class="me-3" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path
                                 d="M7.65103 1.07509L9.13535 4.05794C9.24471 4.27405 9.45342 4.42413 9.69414 4.45748L13.0282 4.94306C13.2229 4.97041 13.3996 5.07312 13.519 5.22987C13.637 5.38462 13.6877 5.58072 13.659 5.77348C13.6356 5.93356 13.5603 6.08164 13.4449 6.19503L11.0291 8.53689C10.8524 8.7003 10.7724 8.94242 10.815 9.17921L11.4098 12.4716C11.4732 12.8691 11.2098 13.2439 10.815 13.3193C10.6523 13.3453 10.4856 13.318 10.3389 13.2433L7.36497 11.6938C7.14426 11.5824 6.88353 11.5824 6.66282 11.6938L3.68885 13.2433C3.32343 13.4374 2.87067 13.3053 2.66729 12.9451C2.59194 12.8017 2.56527 12.6383 2.58994 12.4789L3.18474 9.18588C3.22741 8.94976 3.14673 8.7063 2.97069 8.54289L0.554841 6.20236C0.267446 5.92489 0.258777 5.46799 0.535503 5.18051C0.541504 5.17451 0.548172 5.16784 0.554841 5.16117C0.669532 5.04444 0.820231 4.97041 0.982932 4.95106L4.31698 4.46481C4.55703 4.4308 4.76574 4.28206 4.87577 4.06461L6.30674 1.07509C6.4341 0.818961 6.69816 0.659547 6.98489 0.666217H7.07424C7.32296 0.696232 7.53967 0.850311 7.65103 1.07509Z"
                                 fill="currentColor" />
         ...
         <div class="col">
            <div class="mb-4 card">
               <div class="p-4 card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title"><b>Standard Plan</b></h5>
         ...
         <div class="col">
            <div class="mb-4 card">
               <div class="p-4 card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title"><b>Professional Plan</b></h5>
                  <svg width="14" height="14" class="me-2" viewBox="0 0 14 14" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                     <path
                        d="M7.65103 1.07509L9.13535 4.05794C9.24471 4.27405 9.45342 4.42413 9.69414 4.45748L13.0282 4.94306C13.2229 4.97041 13.3996 5.07312 13.519 5.22987C13.637 5.38462 13.6877 5.58072 13.659 5.77348C13.6356 5.93356 13.5603 6.08164 13.4449 6.19503L11.0291 8.53689C10.8524 8.7003 10.7724 8.94242 10.815 9.17921L11.4098 12.4716C11.4732 12.8691 11.2098 13.2439 10.815 13.3193C10.6523 13.3453 10.4856 13.318 10.3389 13.2433L7.36497 11.6938C7.14426 11.5824 6.88353 11.5824 6.66282 11.6938L3.68885 13.2433C3.32343 13.4374 2.87067 13.3053 2.66729 12.9451C2.59194 12.8017 2.56527 12.6383 2.58994 12.4789L3.18474 9.18588C3.22741 8.94976 3.14673 8.7063 2.97069 8.54289L0.554841 6.20236C0.267446 5.92489 0.258777 5.46799 0.535503 5.18051C0.541504 5.17451 0.548172 5.16784 0.554841 5.16117C0.669532 5.04444 0.820231 4.97041 0.982932 4.95106L4.31698 4.46481C4.55703 4.4308 4.76574 4.28206 4.87577 4.06461L6.30674 1.07509C6.4341 0.818961 6.69816 0.659547 6.98489 0.666217H7.07424C7.32296 0.696232 7.53967 0.850311 7.65103 1.07509Z"
         ...
         <div class="col">
            <div class="mb-4 card">
               <div class="p-4 card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title"><b>Business Plan</b></h5>
                  <svg width="14" height="14" class="me-2" viewBox="0 0 14 14" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                     <path
                        d="M7.65103 1.07509L9.13535 4.05794C9.24471 4.27405 9.45342 4.42413 9.69414 4.45748L13.0282 4.94306C13.2229 4.97041 13.3996 5.07312 13.519 5.22987C13.637 5.38462 13.6877 5.58072 13.659 5.77348C13.6356 5.93356 13.5603 6.08164 13.4449 6.19503L11.0291 8.53689C10.8524 8.7003 10.7724 8.94242 10.815 9.17921L11.4098 12.4716C11.4732 12.8691 11.2098 13.2439 10.815 13.3193C10.6523 13.3453 10.4856 13.318 10.3389 13.2433L7.36497 11.6938C7.14426 11.5824 6.88353 11.5824 6.66282 11.6938L3.68885 13.2433C3.32343 13.4374 2.87067 13.3053 2.66729 12.9451C2.59194 12.8017 2.56527 12.6383 2.58994 12.4789L3.18474 9.18588C3.22741 8.94976 3.14673 8.7063 2.97069 8.54289L0.554841 6.20236C0.267446 5.92489 0.258777 5.46799 0.535503 5.18051C0.541504 5.17451 0.548172 5.16784 0.554841 5.16117C0.669532 5.04444 0.820231 4.97041 0.982932 4.95106L4.31698 4.46481C4.55703 4.4308 4.76574 4.28206 4.87577 4.06461L6.30674 1.07509C6.4341 0.818961 6.69816 0.659547 6.98489 0.666217H7.07424C7.32296 0.696232 7.53967 0.850311 7.65103 1.07509Z"
         ...
         <div class="col">
            <div class="mb-4 card">
               <div class="p-4 card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title"><b>VIP Plan</b></h5>
                  <svg width="14" height="14" class="me-2" viewBox="0 0 14 14" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                     <path
                        d="M7.65103 1.07509L9.13535 4.05794C9.24471 4.27405 9.45342 4.42413 9.69414 4.45748L13.0282 4.94306C13.2229 4.97041 13.3996 5.07312 13.519 5.22987C13.637 5.38462 13.6877 5.58072 13.659 5.77348C13.6356 5.93356 13.5603 6.08164 13.4449 6.19503L11.0291 8.53689C10.8524 8.7003 10.7724 8.94242 10.815 9.17921L11.4098 12.4716C11.4732 12.8691 11.2098 13.2439 10.815 13.3193C10.6523 13.3453 10.4856 13.318 10.3389 13.2433L7.36497 11.6938C7.14426 11.5824 6.88353 11.5824 6.66282 11.6938L3.68885 13.2433C3.32343 13.4374 2.87067 13.3053 2.66729 12.9451C2.59194 12.8017 2.56527 12.6383 2.58994 12.4789L3.18474 9.18588C3.22741 8.94976 3.14673 8.7063 2.97069 8.54289L0.554841 6.20236C0.267446 5.92489 0.258777 5.46799 0.535503 5.18051C0.541504 5.17451 0.548172 5.16784 0.554841 5.16117C0.669532 5.04444 0.820231 4.97041 0.982932 4.95106L4.31698 4.46481C4.55703 4.4308 4.76574 4.28206 4.87577 4.06461L6.30674 1.07509C6.4341 0.818961 6.69816 0.659547 6.98489 0.666217H7.07424C7.32296 0.696232 7.53967 0.850311 7.65103 1.07509Z"
         ...
         <div class="col">
            <div class="mb-4 card">
               <div class="p-4 card-header bg-primary-subtle">
                  <h5 class="mb-3 card-title pricing-card-title"><b>Premium Plan</b></h5>
                  <svg width="14" height="14" class="me-2" viewBox="0 0 14 14" fill="none"
                     xmlns="http://www.w3.org/2000/svg">
                     <path
                        d="M7.65103 1.07509L9.13535 4.05794C9.24471 4.27405 9.45342 4.42413 9.69414 4.45748L13.0282 4.94306C13.2229 4.97041 13.3996 5.07312 13.519 5.22987C13.637 5.38462 13.6877 5.58072 13.659 5.77348C13.6356 5.93356 13.5603 6.08164 13.4449 6.19503L11.0291 8.53689C10.8524 8.7003 10.7724 8.94242 10.815 9.17921L11.4098 12.4716C11.4732 12.8691 11.2098 13.2439 10.815 13.3193C10.6523 13.3453 10.4856 13.318 10.3389 13.2433L7.36497 11.6938C7.14426 11.5824 6.88353 11.5824 6.66282 11.6938L3.68885 13.2433C3.32343 13.4374 2.87067 13.3053 2.66729 12.9451C2.59194 12.8017 2.56527 12.6383 2.58994 12.4789L3.18474 9.18588C3.22741 8.94976 3.14673 8.7063 2.97069 8.54289L0.554841 6.20236C0.267446 5.92489 0.258777 5.46799 0.535503 5.18051C0.541504 5.17451 0.548172 5.16784 0.554841 5.16117C0.669532 5.04444 0.820231 4.97041 0.982932 4.95106L4.31698 4.46481C4.55703 4.4308 4.76574 4.28206 4.87577 4.06461L6.30674 1.07509C6.4341 0.818961 6.69816 0.659547 6.98489 0.666217H7.07424C7.32296 0.696232 7.53967 0.850311 7.65103 1.07509Z"
      ...
      <div class="card">
         <div
            class="gap-1 justify-content-center justify-content-sm-between d-flex card-header border-bottom align-items-center">
            <h4 class="mb-0 d-inline-block mb-md-3">Choose Plan</h4>
            <div class="mt-1 d-flex justify-content-center align-items-center mt-sm-0 col-sm-auto">
               <label class="me-2 form-check-label">Monthly</label>
               <div class="form-check form-switch">
                  <input type="checkbox" id="contcheckbox" class="form-check-input" checked="">
                  <label for="yearly" class="align-top ms-2 form-check-label">Yearly</label>
               </div>
            </div>
         </div>
         <div class="card-body">
               ...
               <div class="col">
                  <div class="card pricing-box-2 mb-lg-0">
                     <div class="card-body">
                        ...
                        <h2 class="my-4 pricingtable__highlight yearlypricing"><b>$150/Mo</b></h2>
                        <ul class="p-0 mb-0 list-unstyled">
                           <li>
                        ...
                        <button type="button" class="mt-3 border btn btn-primary">Try For Free</button>
                     </div>
                  </div>
               </div>
               <div class="col">
                  <div class="card pricing-box-2 active mb-lg-0">
                     <div class="card-body">
                        ...
                        <h2 class="my-4 pricingtable__highlight yearlypricing"><b>$200/Mo</b></h2>
                        <ul class="p-0 mb-0 list-unstyled">
                           <li>
                              <p class="mb-4"><svg width="8" class="me-2" viewBox="0 0 8 8" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="col">
                  <div class="card pricing-box-2 mb-lg-0">
                     <div class="card-body">
                        ...
                        <h2 class="my-4 pricingtable__highlight yearlypricing"><b>$50/Mo</b></h2>
                        <ul class="p-0 mb-0 list-unstyled">
                           <li>
                              <p class="mb-4"><svg width="8" class="me-2" viewBox="0 0 8 8" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
