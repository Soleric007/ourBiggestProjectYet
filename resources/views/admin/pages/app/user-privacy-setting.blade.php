                            ...
                            <div class="acc-privacy">
                                <div class="data-privacy">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="pl-2 form-check-label" for="customCheck5">Private Account</label>
                                    </div>
                                ...
                                <div class="data-privacy">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="pl-2 form-check-label" for="activety">Show Activity Status</label>
                                    </div>
                                ...
                                <div class="data-privacy">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="pl-2 form-check-label" for="story">Allow Sharing</label>
                                    </div>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of
                                        a page when looking at its layout. The point of using Lorem Ipsum is that it has a
                                        more-or-less normal distribution of letters, as opposed to using 'Content here, content
                                ...
                                <div class="data-privacy">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label for="automatically" class="pl-2 form-check-label">Add Automatically</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="customRadio0" id="manualy">
                                        <label for="manualy" class="pl-2 form-check-label">Add Manualy</label>
                                    </div>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of
                                        a page when looking at its layout. The point of using Lorem Ipsum is that it has a
                                        more-or-less normal distribution of letters, as opposed to using 'Content here, content
                                ...
                                <div class="data-privacy">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label for="public" class="pl-2 form-check-label">Public</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="customRadio1" id="friend">
                                        <label for="friend" class="pl-2 form-check-label">Friend</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="customRadio1" id="spfriend">
                                        <label for="spfriend" class="pl-2 form-check-label">Specific Friend</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="customRadio1" id="onlyme">
                                        <label for="onlyme" class="pl-2 form-check-label">Only Me</label>
                                    </div>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of
                                        a page when looking at its layout. The point of using Lorem Ipsum is that it has a
                                        more-or-less normal distribution of letters, as opposed to using 'Content here, content
                                ...
                                <div class="data-privacy">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label for="enable" class="pl-2 form-check-label">Enable</label>
                                    </div>
                                    <div class="form-check">
                                        <input type="radio" class="form-check-input" name="customRadio2" id="disable">
                                        <label for="disable" class="pl-2 form-check-label">Disable</label>
                                    </div>
                                    <p>It is a long established fact that a reader will be distracted by the readable content of
                                        a page when looking at its layout. The point of using Lorem Ipsum is that it has a
                                        more-or-less normal distribution of letters, as opposed to using 'Content here, content
