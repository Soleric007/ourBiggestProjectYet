      ...
      <div class="col-sm-12">
         <div class="card">
            <div class="py-3 card-header border-bottom d-flex justify-content-between align-items-center">
               <div class="gap-2 pt-3 d-flex align-items-center">
            ...
            <div class="card-body">
               <div class="py-4 rounded table-responsive table-space">
                  <table id="user-list-table" class="table custom-table" role="grid" data-toggle="data-table">
                     ...
                     <tbody>
                        <tr>
                           <td><img class="rounded bg-primary-subtle img-fluid avatar-40 me-3"
                                 src="../../../../../public/admin/assets/images/user/01.jpg" alt="profile" loading="lazy"></td>
                           <td>Anna Sthesia</td>
                           <td>(760) 756 7568</td>
                           ...
                           <td>
                              <div class="flex align-items-center list-user-action">
                                 <a class="rounded btn btn-sm btn-icon btn-success" data-bs-toggle="tooltip"
                                    data-placement="top" title="" data-bs-original-title="Add" href="#">
                                    <span class="btn-inner">
                                       <i class="fa-solid fa-user-plus fa-xs"></i>
                                    </span>
                                 </a>
                                 <a class="rounded btn btn-sm btn-icon btn-danger delete-btn" data-bs-toggle="tooltip"
                        ...
                        <tr>
                           <td><img class="rounded bg-primary-subtle img-fluid avatar-40 me-3"
                                 src="../../../../../public/admin/assets/images/user/02.jpg" alt="profile" loading="lazy"></td>
                           <td>Brock Lee</td>
                        ...
                        <tr>
                           <td><img class="rounded bg-primary-subtle img-fluid avatar-40 me-3"
                                 src="../../../../../public/admin/assets/images/user/03.jpg" alt="profile" loading="lazy"></td>
                           <td>Dan Druff</td>
                        ...
                        <tr>
                           <td><img class="rounded bg-primary-subtle img-fluid avatar-40 me-3"
                                 src="../../../../../public/admin/assets/images/user/04.jpg" alt="profile" loading="lazy"></td>
                           <td>Hans Olo</td>
                        ...
                        <tr>
                           <td><img class="rounded bg-primary-subtle img-fluid avatar-40 me-3"
                                 src="../../../../../public/admin/assets/images/user/05.jpg" alt="profile" loading="lazy"></td>
                           <td>Lynn Guini</td>
                        ...
                        <tr>
                           <td><img class="rounded bg-primary-subtle img-fluid avatar-40 me-3"
                                 src="../../../../../public/admin/assets/images/user/06.jpg" alt="profile" loading="lazy"></td>
                           <td>Eric Shun</td>
