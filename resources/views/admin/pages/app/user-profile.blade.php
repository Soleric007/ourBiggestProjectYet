...
<head>
    ...
    <link rel="stylesheet" href="../../../../../public/admin/assets/css/streamit.min%EF%B9%96v=5.2.1.css">

    <!-- Custom Css -->
    <link rel="stylesheet" href="../../../../../public/admin/assets/css/custom.min%EF%B9%96v=5.2.1.css">
    <link rel="stylesheet" href="../../../../../public/admin/assets/css/dashboard-custom.min%EF%B9%96v=5.2.1.css">

    <!-- RTL Css -->
    <link rel="stylesheet" href="../../../../../public/admin/assets/css/rtl.min%EF%B9%96v=5.2.1.css">

    <!-- Customizer Css -->
    <link rel="stylesheet" href="../../../../../public/admin/assets/css/customizer.min%EF%B9%96v=5.2.1.css">
...
<body class="">
    ...
    <div id="loading">
        <div class="loader simple-loader">
            <div class="loader-body ">
                <img src="../../../../../public/admin/assets/images/loader-unscreen.gif" class="image-loader img-fluid" />
            </div>
        </div>    </div>
    <!-- loader END -->
    <aside class="sidebar sidebar-base sidebar-white sidebar-default navs-rounded-all " id="first-tour" data-toggle="main-sidebar" data-sidebar="responsive">
        <div class="sidebar-header d-flex align-items-center justify-content-start">
            <a href="../index.html" class="navbar-brand">
                ...
                <!--Logo start-->
                       <img class="logo-normal" src="../../../../../public/admin/assets/images/logo.png" alt="#">
                       <img class="logo-normal logo-white" src="../../../../../public/admin/assets/images/logo-white.png" alt="#">
                       <img class="logo-full"  src="../../../../../public/admin/assets/images/logo-full.png" alt="#">
                       <img class="logo-full logo-full-white"  src="../../../../../public/admin/assets/images/logo-full-white.png" alt="#">
                <!--logo End-->        </a>
    ...
    <main class="main-content">
            ...
            <nav class="nav navbar navbar-expand-xl header-hover-menu navbar-light iq-navbar">
               <div class="container-fluid navbar-inner">
                  ...
                  <div class="d-flex align-items-center justify-content-between product-offcanvas">
                     ...
                     <div class="shadow-none offcanvas offcanvas-end iq-product-menu-responsive" tabindex="-1" id="offcanvasBottom">
                  ...
                  <div class="d-flex align-items-center">
                     <button id="navbar-toggle" class="navbar-toggler" type="button" data-bs-toggle="collapse"
                        ...
                        <span class="navbar-toggler-icon">
                           <span class="mt-1 navbar-toggler-bar bar1"></span>
                     ...
                     <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0 ">
                           ...
                           <ul class="p-0 sub-drop dropdown-menu dropdown-menu-end" aria-labelledby="search-drop">
                              <li>
                                 ...
                                 <div class="p-0 card-body all-notification">
                                    <div class="px-3 py-2 d-flex align-items-center border-bottom search-hover">
                                       <div class="flex-shrink-0">
                                          <img src="../../../../../public/admin/assets/images/avatars/01.png"
                                    ...
                                    <div class="px-3 py-2 d-flex align-items-center border-bottom search-hover">
                                       <div class="flex-shrink-0">
                                          <img src="../../../../../public/admin/assets/images/avatars/02.png"
                                             class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                       </div>
                                       <div class="d-flex flex-column ms-3 w-100">
                                    ...
                                    <div class="px-3 py-2 d-flex align-items-center search-hover border-bottom">
                                       <div class="flex-shrink-0">
                                          <img src="../../../../../public/admin/assets/images/avatars/03.png"
                                             class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                       </div>
                                       <div class="d-flex flex-column ms-3 w-100">
                                    ...
                                    <div class="px-3 py-2 d-flex align-items-center border-bottom search-hover">
                                       <div class="flex-shrink-0">
                                          <img src="../../../../../public/admin/assets/images/avatars/04.png"
                                             class="align-self-center img-fluid avatar-50 rounded-pill" alt="#">
                                       </div>
                                       <div class="d-flex flex-column ms-3 w-100">
                                          <a href="javascript:void(0);" class="h5">Monty Carlo</a>
                                 ...
                                 <div class="p-0 card-body all-notification">
                                    <a href="#" class="iq-sub-card">
                                       <div class="d-flex align-items-center">
                                          <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                             src="../../../../../public/admin/assets/images/shapes/01.png" alt="" loading="lazy">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="d-flex align-items-center">
                                          <div>
                                             <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                                src="../../../../../public/admin/assets/images/shapes/02.png" alt="" loading="lazy">
                                          </div>
                                          <div class="ms-3 w-100">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="d-flex align-items-center">
                                          <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                             src="../../../../../public/admin/assets/images/shapes/03.png" alt="" loading="lazy">
                                          <div class="ms-3 w-100">
                                    ...
                                    <a href="#" class="iq-sub-card">
                                       <div class="d-flex align-items-center">
                                          <img class="p-1 avatar-40 rounded-pill bg-primary-subtle"
                                             src="../../../../../public/admin/assets/images/shapes/04.png" alt="" loading="lazy">
                              ...
                              <li data-setting="radio">
                                 <div class="dropdown-item d-flex align-items-center">
                                    ...
                                    <label class="d-block" for="color-mode-light">
                                       ...
                                       <span class="mb-0 ms-3">Light</span>
                                    </label>
                                 </div>
                              </li>
                              <li data-setting="radio">
                                 <div class="dropdown-item d-flex align-items-center">
                                    ...
                                    <label class="d-block" for="color-mode-dark">
                                       ...
                                       <span class="mb-0 ms-3">Dark</span>
                                    </label>
                                 </div>
                              </li>
                              <li data-setting="radio">
                                 <div class="dropdown-item d-flex align-items-center">
                                    ...
                                    <label class="d-block" for="color-mode-auto">
                                       ...
                                       <span class="mb-0 ms-3">Auto</span>
                                    </label>
                                 </div>
                              </li>
                           </ul>
                        ...
                        <li class="nav-item dropdown">
                           <a class="py-0 nav-link d-flex align-items-center ps-3" href="#" id="profile-setting" role="button"
                              ...
                              <img src="../../../../../public/admin/assets/images/user/01.jpg" alt="User-Profile"
                              ...
                              <img src="../../../../../public/admin/assets/images/user/02.jpg" alt="User-Profile"
                                 class="theme-color-blue-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                              <img src="../../../../../public/admin/assets/images/user/03.jpg" alt="User-Profile"
                                 class="theme-color-green-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                              <img src="../../../../../public/admin/assets/images/user/04.jpg" alt="User-Profile"
                                 class="theme-color-yellow-img img-fluid avatar avatar-50 avatar-rounded" loading="lazy">
                              <img src="../../../../../public/admin/assets/images/user/05.jpg" alt="User-Profile"
                           ...
                           <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="profile-setting">
                              ...
                              <li><a class="dropdown-item" href="user-privacy-setting.html">Privacy
                                    Setting</a></li>
                              <li>
        ...
        <div class="pb-0 content-inner container-fluid" id="page_layout">
      <div class="row">
          <div class="col-lg-12">
             <div class="card">
                  <div class="card-body">
                     <div class="flex-wrap d-flex align-items-center justify-content-between">
                        <div class="flex-wrap d-flex align-items-center">
                           <div class="mb-3 profile-img position-relative me-3 mb-lg-0 profile-logo profile-logo1">
                              <img src="../../../../../public/admin/assets/images/avatars/01.png" alt="User-Profile" class="theme-color-default-img img-fluid rounded-pill avatar-100" loading="lazy">
                              <img src="../../../../../public/admin/assets/images/avatars/02.png" alt="User-Profile" class="theme-color-purple-img img-fluid rounded-pill avatar-100" loading="lazy">
                              <img src="../../../../../public/admin/assets/images/avatars/03.png" alt="User-Profile" class="theme-color-blue-img img-fluid rounded-pill avatar-100" loading="lazy">
                              <img src="../../../../../public/admin/assets/images/avatars/04.png" alt="User-Profile" class="theme-color-green-img img-fluid rounded-pill avatar-100" loading="lazy">
                              <img src="../../../../../public/admin/assets/images/avatars/05.png" alt="User-Profile" class="theme-color-yellow-img img-fluid rounded-pill avatar-100" loading="lazy">
                              <img src="../../../../../public/admin/assets/images/avatars/06.png" alt="User-Profile" class="theme-color-pink-img img-fluid rounded-pill avatar-100" loading="lazy">
                           </div>
                           <div class="flex-wrap mb-3 d-flex align-items-center mb-sm-0">
                              <h4 class="me-2 h4">Austin Robertson</h4>
                              <span> - Web Developer</span>
                           </div>
                        </div>
                        <ul class="mb-0 text-center d-flex nav nav-pills profile-tab" data-toggle="slider-tab" id="profile-pills-tab" role="tablist">
                           <li class="nav-item">
          ...
          <div class="col-lg-3">
               ...
               <div class="card-body">
                  <ul class="p-0 m-0 list-inline">
                     <li class="mb-2 d-flex">
                        ...
                        <p class="mb-0 news-detail">there is a meetup in your city on fryday at 19:00. <a href="#">see details</a></p>
                     </li>
                     <li class="d-flex">
                        <div class="news-icon me-3">
                           <svg width="20" viewBox="0 0 24 24">
                        ...
                        <p class="mb-0 news-detail">20% off coupon on selected items at pharmaprix </p>
                     </li>
                  </ul>
               </div>
             </div>
             <div class="card">
               ...
               <div class="card-body">
                  <div class="grid-cols-3 d-grid gap-card">
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/icon/04.png">
                        <img src="../../../../../public/admin/assets/images/icon/04.png" class="rounded img-fluid bg-info-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/shapes/02.png">
                        <img src="../../../../../public/admin/assets/images/shapes/02.png" class="rounded img-fluid bg-primary-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/icon/08.png">
                        <img src="../../../../../public/admin/assets/images/icon/08.png" class="rounded img-fluid bg-info-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/shapes/04.png">
                        <img src="../../../../../public/admin/assets/images/shapes/04.png" class="rounded img-fluid bg-primary-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/shapes/03.png">
                        <img src="../../../../../public/admin/assets/images/shapes/03.png" class="rounded img-fluid bg-warning-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/shapes/06.png">
                        <img src="../../../../../public/admin/assets/images/shapes/06.png" class="rounded img-fluid bg-primary-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/shapes/05.png">
                        <img src="../../../../../public/admin/assets/images/shapes/05.png" class="rounded img-fluid bg-danger-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/shapes/08.png">
                        <img src="../../../../../public/admin/assets/images/shapes/04.png" class="rounded img-fluid bg-primary-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                     <a data-fslightbox="gallery" href="../../../../../public/admin/assets/images/icon/01.png">
                        <img src="../../../../../public/admin/assets/images/icon/01.png" class="rounded img-fluid bg-success-subtle w-100" alt="profile-image" loading="lazy">
                     </a>
                  </div>
               </div>
             </div>
               ...
               <div class="card-body">
                  <div class="twit-feed">
                     <div class="mb-2 d-flex align-items-center">
                        <img class="p-1 rounded-pill img-fluid avatar-50 me-3 bg-danger-subtle ps-2" src="../../../../../public/admin/assets/images/avatars/03.png" alt="" loading="lazy">
                  ...
                  <div class="twit-feed">
                     <div class="mb-2 d-flex align-items-center">
                        <img class="p-1 rounded-pill img-fluid avatar-50 me-3 bg-primary-subtle" src="../../../../../public/admin/assets/images/avatars/04.png" alt="" loading="lazy">
                        <div class="media-support-info">
                  ...
                  <div class="twit-feed">
                     <div class="mb-2 d-flex align-items-center">
                           <img class="p-1 pt-2 rounded-pill img-fluid avatar-50 me-3 bg-warning-subtle" src="../../../../../public/admin/assets/images/avatars/02.png" alt="" loading="lazy">
                        <div class="mt-2">
          ...
          <div class="col-lg-6">
             <div class="profile-content tab-content iq-tab-fade-up">
               <div id="profile-feed" class="tab-pane fade active show">
                  <div class="card">
                     <div class="pb-4 card-header d-flex align-items-center justify-content-between">
                        <div class="header-title">
                           <div class="flex-wrap d-flex">
                              <div class="media-support-user-img me-3">
                                 <img class="p-1 rounded-pill img-fluid avatar-60 bg-danger-subtle ps-2" src="../../../../../public/admin/assets/images/avatars/02.png" alt="" loading="lazy">
                              </div>
                              <div class="mt-2 media-support-info">
                     ...
                     <div class="p-0 card-body">
                        <div class="user-post">
                           <a href="javascript:void(0);"><img src="../../../../../public/admin/assets/images/pages/03-page.jpg" alt="post-image" class="img-fluid" loading="lazy"></a>
                        </div>
                        <div class="p-3 comment-area">
                           ...
                           <ul class="p-0 m-0 list-inline">
                              <li class="mb-2">
                                 <div class="d-flex">
                                    <img src="../../../../../public/admin/assets/images/avatars/03.png" alt="userimg" class="p-1 pt-2 avatar-50 bg-primary-subtle rounded-pill img-fluid" loading="lazy">
                                    <div class="ms-3">
                              ...
                              <li>
                                 <div class="d-flex">
                                    <img src="../../../../../public/admin/assets/images/avatars/04.png" alt="userimg" class="p-1 avatar-50 bg-danger-subtle rounded-pill img-fluid" loading="lazy">
                                    <div class="ms-3">
                           ...
                           <form class="mt-3 comment-text d-flex align-items-center" action="javascript:void(0);">
                  ...
                  <div class="card">
                     <div class="pb-4 card-header d-flex align-items-center justify-content-between">
                        <div class="header-title">
                           <div class="flex-wrap d-flex">
                              <div class="media-support-user-img me-3">
                                 <img class="p-1 rounded-pill img-fluid avatar-60 bg-info-subtle" src="../../../../../public/admin/assets/images/avatars/05.png" alt="" loading="lazy">
                              </div>
                              <div class="mt-2 media-support-info">
                     ...
                     <div class="p-0 card-body">
                           ...
                           <div class="p-3 comment-area"><hr class="mt-0">
                           <div class="flex-wrap d-flex justify-content-between align-items-center">
                              <div class="d-flex align-items-center">
                                 <div class="d-flex align-items-center me-3">
                                    <svg class="icon-20" width="20" viewBox="0 0 24 24">
               ...
               <div id="profile-activity" class="tab-pane fade">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="m-0 iq-timeline0 d-flex align-items-center justify-content-between position-relative">
                           <ul class="p-0 m-0 list-inline">
                              <li>
                     ...
                     <div class="card-body">
                        <ul class="p-0 m-0 list-inline">
                           <li class="mb-4 d-flex align-items-center">
                              <img src="../../../../../public/admin/assets/images/avatars/01.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy">
                           ...
                           <li class="mb-4 d-flex align-items-center">
                              <img src="../../../../../public/admin/assets/images/avatars/05.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy">
                              <div class="ms-3 flex-grow-1">
                                 <h6>Paul Molive</h6>
                           ...
                           <li class="mb-4 d-flex align-items-center">
                              <img src="../../../../../public/admin/assets/images/avatars/02.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy">
                              <div class="ms-3 flex-grow-1">
                                 <h6>Anna Mull</h6>
                           ...
                           <li class="mb-4 d-flex align-items-center">
                              <img src="../../../../../public/admin/assets/images/avatars/03.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy">
                              <div class="ms-3 flex-grow-1">
                                 <h6>Paige Turner</h6>
                                 <p class="mb-0">trainee</p>
                              </div>
                           ...
                           <li class="mb-4 d-flex align-items-center">
                              <img src="../../../../../public/admin/assets/images/avatars/04.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy">
                              <div class="ms-3 flex-grow-1">
                                 <h6>Barb Ackue</h6>
                                 <p class="mb-0">Web Designer</p>
                              </div>
                           ...
                           <li class="mb-4 d-flex align-items-center">
                              <img src="../../../../../public/admin/assets/images/avatars/03.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy">                              <div class="ms-3 flex-grow-1">
                                 <h6>Ira Membrit</h6>
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <div class="text-center">
                           <div>
                              <img src="../../../../../public/admin/assets/images/avatars/01.png" alt="profile-img" class="rounded-pill avatar-130 img-fluid" loading="lazy">
                           </div>
                           <div class="mt-3">
                              <h3 class="d-inline-block">Austin Robertson</h3>
                              <p class="pl-3 d-inline-block"> - Web developer</p>
          ...
          <div class="col-lg-3">
             ...
             <div class="card">
               ...
               <div class="card-body">
                  <ul class="p-0 m-0 list-inline">
                     <li class="mb-4 d-flex align-items-center active">
                        <img src="../../../../../public/admin/assets/images/shapes/02.png" alt="story-img" class="p-1 border rounded-pill avatar-70 bg-soft-light img-fluid" loading="lazy">
                        <div class="ms-3">
                           <h5>Web Design</h5>
                     ...
                     <li class="mb-4 d-flex align-items-center">
                        <img src="../../../../../public/admin/assets/images/shapes/04.png" alt="story-img" class="p-1 border rounded-pill avatar-70 img-fluid bg-danger-subtle" loading="lazy">
                        <div class="ms-3">
                           <h5>App Design</h5>
                     ...
                     <li class="d-flex align-items-center">
                        <img src="../../../../../public/admin/assets/images/shapes/06.png" alt="story-img" class="p-1 border rounded-pill avatar-70 bg-primary-subtle img-fluid" loading="lazy">
                        <div class="ms-3">
             ...
             <div class="card">
               ...
               <div class="card-body">
                  <ul class="p-0 m-0 list-inline">
                     <li class="mb-4 d-flex align-items-center">
                        <div class="img-fluid bg-warning-subtle rounded-pill"><img src="../../../../../public/admin/assets/images/avatars/02.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Paul Molive</h6>
                           <p class="mb-0">4 mutual friends</p>
                        </div>
                        <a href="javascript:void(0);" class="p-2 btn btn-outline-primary rounded-circle btn-icon btn-sm">
                           <span class="btn-inner">
                     ...
                     <li class="mb-4 d-flex align-items-center">
                        <div class="img-fluid bg-danger-subtle rounded-pill"><img src="../../../../../public/admin/assets/images/avatars/03.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Robert Fox</h6>
                           <p class="mb-0">4 mutual friends</p>
                        </div>
                     ...
                     <li class="mb-4 d-flex align-items-center">
                        <div class="img-fluid bg-dark-subtle rounded-pill"><img src="../../../../../public/admin/assets/images/avatars/04.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Jenny Wilson</h6>
                     ...
                     <li class="mb-4 d-flex align-items-center">
                        <div class="img-fluid bg-primary-subtle rounded-pill"><img src="../../../../../public/admin/assets/images/avatars/05.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Cody Fisher</h6>
                     ...
                     <li class="mb-4 d-flex align-items-center">
                        <div class="img-fluid bg-info-subtle rounded-pill"><img src="../../../../../public/admin/assets/images/avatars/06.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Bessie Cooper</h6>
                     ...
                     <li class="mb-4 d-flex align-items-center">
                        <div class="img-fluid bg-warning-subtle rounded-pill"><img src="../../../../../public/admin/assets/images/avatars/07.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Wade Warren</h6>
                     ...
                     <li class="mb-4 d-flex align-items-center">
                        <div class="img-fluid bg-success-subtle rounded-pill"><img src="../../../../../public/admin/assets/images/avatars/08.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Guy Hawkins</h6>
                     ...
                     <li class="d-flex align-items-center">
                        <div class="img-fluid bg-info-subtle rounded-pill"><img src="../../../../../public/admin/assets/images/avatars/09.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Floyd Miles</h6>
      ...
      <div class="offcanvas offcanvas-bottom share-offcanvas" tabindex="-1" id="share-btn" aria-labelledby="shareBottomLabel">
         ...
         <div class="offcanvas-body small">
            <div class="flex-wrap d-flex align-items-center">
               <div class="mb-3 text-center me-3">
                  <img src="../../../../../public/admin/assets/images/brands/08.png" class="mb-2 rounded img-fluid" alt="" loading="lazy">
                  <h6>Facebook</h6>
               </div>
               <div class="mb-3 text-center me-3">
                  <img src="../../../../../public/admin/assets/images/brands/09.png" class="mb-2 rounded img-fluid" alt="" loading="lazy">
                  <h6>Twitter</h6>
               </div>
               <div class="mb-3 text-center me-3">
                  <img src="../../../../../public/admin/assets/images/brands/10.png" class="mb-2 rounded img-fluid" alt="" loading="lazy">
                  <h6>Instagram</h6>
               </div>
               <div class="mb-3 text-center me-3">
                  <img src="../../../../../public/admin/assets/images/brands/11.png" class="mb-2 rounded img-fluid" alt="" loading="lazy">
                  <h6>Google Plus</h6>
               </div>
               <div class="mb-3 text-center me-3">
                  <img src="../../../../../public/admin/assets/images/brands/13.png" class="mb-2 rounded img-fluid" alt="" loading="lazy">
                  <h6>In</h6>
               </div>
               <div class="mb-3 text-center me-3">
                  <img src="../../../../../public/admin/assets/images/brands/12.png" class="mb-2 rounded img-fluid" alt="" loading="lazy">
                  <h6>YouTube</h6>
               </div>
            </div>
         </div>
                        ...
                        <div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="mb-3 " data-setting="radio">
                                    <div class="mb-0 form-check w-100">
                            ...
                            <div>
                                ...
                                <div class="grid-cols-3 gap-3 mb-3 d-grid">
                                ...
                                <div class="grid-cols-3 gap-3 mb-4 d-grid">
                                    <div data-setting="checkbox" class="text-center">
                                        <input type="checkbox" value="sidebar-mini" class="btn-check" name="sidebar_type"
                                            id="sidebar-mini">
                                        <label class="overflow-hidden btn btn-border btn-setting-panel d-block"
                                            for="sidebar-mini">
                                            Mini
                                        </label>
                                    </div>
                            ...
                            <div>
                                <div class="d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div data-setting="radio">
                                            ...
                                            <label class="px-2 bg-transparent border-0 btn" for="default"
                                ...
                                <div class="grid-cols-2 gap-3 mb-4 d-grid">
                                    <div data-setting="radio">
                                        ...
                                        <label class="bg-transparent btn btn-border d-block" for="theme-color-1"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div data-setting="radio">
                                        ...
                                        <label class="bg-transparent btn btn-border d-block" for="theme-color-2"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div data-setting="radio">
                                        ...
                                        <label class="bg-transparent btn btn-border d-block" for="theme-color-3"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div data-setting="radio">
                                        ...
                                        <label class="bg-transparent btn btn-border d-block" for="theme-color-4"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            <hr class="hr-horizontal">
                            <div>
                                <h6 class="mb-3 d-inline-block me-2">Page Style </h6>
                                <div class="grid-cols-2 gap-3 mb-4 d-grid">
                                    <div data-setting="radio">
                            ...
                            <div>
                                <h5 class="mt-4 mb-3">Direction</h5>
                                <div class="mb-3 " data-setting="radio">
                                    <div class="mb-0 form-check w-100">
    ...
    <!-- Slider-tab Script -->
    <script src="../../../../../public/admin/assets/js/plugins/slider-tabs.js"></script>

    <!-- fslightbox Script -->
    <script src="../../../../../public/admin/assets/js/plugins/fslightbox.js" defer></script>




    <!-- Lodash Utility -->
    <script src="../../../../../public/admin/assets/vendor/lodash/lodash.min.js"></script>
    <!-- Utilities Functions -->
    <script src="../../../../../public/admin/assets/js/iqonic-script/utility.min.js"></script>
    <!-- Settings Script -->
    <script src="../../../../../public/admin/assets/js/iqonic-script/setting.min.js"></script>
    <!-- Settings Init Script -->
    <script src="../../../../../public/admin/assets/js/setting-init.js"></script>
    <!-- External Library Bundle Script -->
    <script src="../../../../../public/admin/assets/js/core/external.min.js"></script>
    <!-- Widgetchart Script -->
    <script src="../../../../../public/admin/assets/js/charts/widgetcharts%EF%B9%96v=5.2.1.js" defer></script>
    <!-- Dashboard Script -->
    <script src="../../../../../public/admin/assets/js/charts/dashboard%EF%B9%96v=5.2.1.js" defer></script>
    <!-- qompacui Script -->
    <script src="../../../../../public/admin/assets/js/streamit%EF%B9%96v=5.2.1.js" defer></script>
    <script src="../../../../../public/admin/assets/js/sidebar%EF%B9%96v=5.2.1.js" defer></script>
    <script src="../../../../../public/admin/assets/js/chart-custom%EF%B9%96v=5.2.1.js" defer></script>

    <script src="../../../../../public/admin/assets/js/plugins/select2%EF%B9%96v=5.2.1.js" defer></script>

    <script src="../../../../../public/admin/assets/js/plugins/flatpickr%EF%B9%96v=5.2.1.js" defer></script>

    <script src="../../../../../public/admin/assets/js/plugins/countdown%EF%B9%96v=5.2.1.js" defer></script>
